...
import talksBanner from "../../assets/talks.png"
import {
...
const workshopEvent: Event = {
  name: "Y20 TALKS",
  description: `Y20 Talks is an international youth platform that aims to bring together young leaders from across the world to discuss and address global challenges. The platform hosts events and conferences where young people can share their perspectives and ideas on issues ranging from climate change to economic inequality.

  In association with Think India, Y20 Talks has been working to promote youth engagement in policy-making and governance in India. Think India is a national organization that seeks to promote intellectual dialogue and critical thinking among young people in India.
  
  Together, Y20 Talks and Think India have organized several events and initiatives aimed at empowering young people in India to become active citizens and leaders. Through workshops, seminars, and conferences, they provide a platform for young people to exchange ideas, learn from experts, and engage in constructive dialogue on issues that matter to them.
  
  The collaboration between Y20 Talks and Think India is an excellent example of how young people can come together to create positive change and make a difference in their communities and the world. By empowering young leaders and promoting their voices, they are creating a more inclusive and equitable future for all.`,
  club: "Abhisarga",
  banner: talksBanner,
  getUrl: (color: string) => "#"
};
...
const technicalEvent: Event = {
  ...
  description: "All the events held in Abhisarga 2023 will be live from 5pm onwards",
  club: "Abhisarga",
  getUrl: (color: string) => "https://iiits.in"
};
